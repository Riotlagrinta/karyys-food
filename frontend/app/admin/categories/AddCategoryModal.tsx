  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-primary text-white font-medium rounded-xl hover:bg-primary/90 transition-colors shadow-sm"
      >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  name="name"
                  required
                  placeholder="ex: Desserts Glacés"
